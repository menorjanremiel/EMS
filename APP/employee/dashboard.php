...
<?php
    ...
    if( mysqli_num_rows($e) > 0 ){
        ...
        $sql_highest_salary =  "SELECT * FROM employees ORDER BY salary DESC";
...
<div class="container text-dark">
    ...
    <div class="col-12">
        ...
        <?php while( $emp_info = mysqli_fetch_assoc($emp_) ){
                    $emp_id = $emp_info["id"];
                    $emp_firstname = $emp_info["firstname"];
                    $emp_lastname = $emp_info["lastname"];
                    $emp_email = $emp_info["email"];
                    $emp_salary = $emp_info["salary"];
                    ?>
            <tr>
            <th ><?php echo "$i. "; ?></th>
            <td><?php echo $emp_firstname; ?></td>
            <td><?php echo $emp_lastname; ?></td>
